...
export const activeTournaments: Tournament[] = [
  {
    ...
    rounds: [
      ...
      '- Clau (PSÍQUICO) vs Antonio (VENENO)',
      '- Charion/ Rb (DRAGÓN) vs James (TIERRA)',
      '- Mario (VOLADOR) vs Isma (FANTASMA)',
      '- Manue (BICHO) vs Sergio (HADA)',
      '- Enri (SINIESTRO) vs Fran (ROCA)',
      '- José Torrico (ELÉCTRICO) vs Dolphin (HIELO)',
    ],
  },
]
