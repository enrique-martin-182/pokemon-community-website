...
export default function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  return (
    ...
    >
      <span aria-hidden className="absolute left-3 text-neutral-600 dark:text-neutral-400 opacity-70">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
          <circle cx="12" cy="12" r="3.5" />
          <path strokeLinecap="round" d="M12 2.5v3M12 18.5v3M2.5 12h3M18.5 12h3M4.6 4.6l2.1 2.1M17.3 17.3l2.1 2.1M4.6 19.4l2.1-2.1M17.3 6.9l2.1-2.1"/>
        </svg>
      </span>
      <span aria-hidden className="absolute right-3 text-neutral-400 dark:text-neutral-600 opacity-60">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
